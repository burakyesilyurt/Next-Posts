export const ActionButton = ({ comment }: { comment: string }) => {
  return (

    <button
      className="text-white px-4 w-auto h-8 bg-red-600 rounded-full hover:bg-red-700 active:shadow-lg mouse shadow transition ease-in duration-200 focus:outline-none">
